        ...
        public static AutoDefenseDefinition CreateDefinition()
        {
            ...
            return new AutoDefenseDefinition(
                ...
                new[]
                {
                    ...
                    new AutoDefenseWeaponModuleDefinition(projectileMount, new WeaponDefinition(projectileWeaponId, WeaponFireMode.Projectile, AttackId, 20, ProjectileId), Source("projectile"))
                });
        }
